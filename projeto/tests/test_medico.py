import sys
sys.path.append('/workspaces/Atividade-Pontuada-1.0')
import pytest
...
def test_validar_setor_pessoa_valida(pessoa_valida):
    assert pessoa_valida.setor == Setor.SAUDE

def test_validar_salario_pessoa_valida(pessoa_valida):
    assert pessoa_valida.salario == 3200.00

def test_validar_crm_pessoa_valida(pessoa_valida):
    assert pessoa_valida.crm == "093_CRM"
